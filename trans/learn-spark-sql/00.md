...
我们将从 Spark SQL 的基础知识及其在 Spark 应用程序中的作用开始这本书。在初步熟悉了 Spark SQL 之后，我们将专注于使用 Spark SQL 来执行所有大数据项目共有的任务，例如处理各种类型的数据源、探索性数据分析和数据管理。我们还将看到如何利用Spark SQL 和Spark来大规模完成典型的数据科学任务。
...
[第 9 章](09.html#4U9TC0-e9cbc07f866e437b8aa14e841622275c)、*使用 Spark SQL* 开发应用程序，帮助您使用 Spark 模块的混合构建 Spark 应用程序。它提供了将Spark SQL 与Spark流、Spark机器学习等相结合的应用程序示例。
