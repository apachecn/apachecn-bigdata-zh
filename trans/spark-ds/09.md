...
1.  The source code to read data and register as a SQL View:
    ...
    **Scala(默认)**:
    ...
    ![Summarizing and visualizing](graphics/image_09_001.jpg)

    **【pyspark】**:

    ![Summarizing and visualizing](graphics/image_09_002.jpg)

    **R** :

    ![Summarizing and visualizing](graphics/image_09_003.jpg)
...
2.  The script to produce quarterly sales for two products:
    ...
    ![Summarizing and visualizing](graphics/image_09_004.jpg)

3.  The output produced:

    ![Summarizing and visualizing](graphics/image_09_005.jpg)
...
![Summarizing and visualizing](graphics/image_09_006.jpg)

这是生成的输出(它可能作为单独的窗口出现):

![Summarizing and visualizing](graphics/image_09_007.jpg)
...
1.  Read data and register the SQL view:
    ...
    ![Subsetting and visualizing](graphics/image_09_008.jpg)

2.  Subset managers' data and show a bubble plot:

    ![Subsetting and visualizing](graphics/image_09_009.jpg)
...
![Subsetting and visualizing](graphics/image_09_010.jpg)
...
![Subsetting and visualizing](graphics/image_09_011.jpg)
...
![Sampling and visualizing](graphics/image_09_012.jpg)

使用`stripplot`渲染数据:

![Sampling and visualizing](graphics/image_09_013.jpg)
...
![Sampling and visualizing](graphics/image_09_014.jpg)
...
![Modeling and visualizing](graphics/image_09_015.jpg)

下一步是编写所需的 SQL 查询并定义适当的设置。请注意 UNION 运算符在 SQL 中的使用以及匹配列的定义方式。

定义 SQL 以查看模型性能:

![Modeling and visualizing](graphics/image_09_016.jpg)

下图有助于我们理解模型预测与实际数据的偏差。这种可视化有助于获取业务用户的输入，因为它们不需要任何数据科学的先验知识来理解:

![Modeling and visualizing](graphics/image_09_017.jpg)
