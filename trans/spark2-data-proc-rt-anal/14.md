...
![](Images/870bc634-f412-46c1-9857-83ed6e05183f.png)
...
![](Images/bc4b1c43-9ed0-4396-a06a-d12c2a3d181d.png)
...
![](Images/e50796d1-a612-4089-b44f-1ffb5c933bab.png)
...
![](Images/18ed269a-1079-4fd8-a2c0-6a75e4e93fcb.png)
...
![](Images/bc6b63fe-5651-462d-8966-636bec6ba119.png)
...
![](Images/86a123c5-915b-40b8-ae00-55fac3375b57.png)
...
![](Images/46e18b3f-0a38-44c0-bebf-24f741ebe8f6.png)
...
![](Images/1eac50f4-acad-4b14-a479-aa390fe87a9b.png)
...
![](Images/f1c9d196-7b32-40ea-9303-66fa819f52f7.png)
...
![](Images/1fbb5236-33c4-443b-b46c-c506f0c66782.png)
...
![](Images/a85bbb8a-37a8-4880-ac6f-e8ede49bdb67.png)
...
![](Images/f3315b50-1445-4633-a0d5-ffaf8256afd5.png)

文档分析有两种方法。我们可以简单地使用矩阵分解将一个大的数据集矩阵分解成一个较小的矩阵(主题分配)乘以一个向量(主题本身):

![](Images/1f6891f4-b0ce-476a-bda5-d52d10745a60.png)
...
![](Images/d39d25e2-be84-46b3-917a-52c3907e3122.png)
...
![](Images/6ef1d102-cb06-48cd-b26c-9f71ac6bbb9d.png)

如下图所示，流面板将显示前面的流 KMeans 矩阵作为显示的矩阵，在这种情况下，批处理作业每 10 秒运行一次:

![](Images/b14bd318-6028-4597-bf45-ca1e5a3dcd9d.png)

您可以通过单击任何一个批处理来获得更多有关流式批处理的详细信息，如下图所示:

![](Images/1a690bac-440b-4891-a843-1270709933a4.png)
...
目前，除了流 KMeans 之外，火花机器库中还有其他算法，如下图所示:

![](Images/7e339c28-5370-47c9-bd81-086eb04f7ca0.png)
