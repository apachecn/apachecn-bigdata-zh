...
以下是第一章的结论。 本章概述了在 Storm 出现之前应用是如何开发的。 当我们通读这一章并接近结论时，我们还获得了关于什么是实时计算以及 Storm 作为编程框架如何变得如此流行的简要知识。 本章教您如何执行Storm配置。 它还提供了有关暴风、暴风群集的守护进程及其升级的详细信息。 在下一章中，我们将探索Storm的解剖细节。