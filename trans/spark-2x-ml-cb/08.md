...
流 KMeans 是 KMeans 实现的特殊情况，在这种情况下，数据可以接近实时到达，并根据需要分类到一个集群中(硬分类)。应用非常广泛，可以从接近实时的异常检测(欺诈、犯罪、情报、监控和监视)到金融领域的沃罗诺伊图细粒度微部门旋转可视化。[第 13 章](13.html#G12EK0-4d291c9fed174a6992fd24938c2f9c77)、*Spark流和机器学习库*提供了更详细的流覆盖。
