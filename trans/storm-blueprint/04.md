...
![Architecture](graphics/8294OS_04_01.jpg)
...
![Introducing the log analysis topology](graphics/8294OS_04_02.jpg)
...
![Calculating a moving average](graphics/8294OS_04_03.jpg)
...
![Running the log analysis topology](graphics/8294OS_04_04.jpg)

接下来，运行`RogueApplication`类并等待一分钟。 您应该会收到一条即时消息通知，指示已超过阈值，随后将收到一条指示恢复正常(低于阈值)的即时消息通知，如以下屏幕截图所示：

![Running the log analysis topology](graphics/8294OS_04_05.jpg)
