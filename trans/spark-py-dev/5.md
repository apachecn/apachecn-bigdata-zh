...
![Laying the foundations of streaming architecture](graphics/B03968_05_01.jpg)
...
![Spark Streaming inner working](graphics/B03968_05_02.jpg)

火花接收器可以从许多来源接收数据。 核心输入源从 TCP 套接字和 HDFS/Amazon S3 到 Akka Actors。 其他来源包括 Apache Kafka、Apache Flume、Amazon Kinesis、ZeroMQ、Twitter 和自定义或用户定义的接收器。

我们区分了向源确认收到数据的可靠资源和用于可能重新发送的复制，以及不确认收到消息的不可靠接收方。 Spark 在工作进程、分区和接收器的数量方面进行了横向扩展。

下图概述了 Spark Streaming 及其可能的来源和持久性选项：

![Spark Streaming inner working](graphics/B03968_05_03.jpg)
...
![Going under the hood of Spark Streaming](graphics/B03968_05_04.jpg)
...
![Going under the hood of Spark Streaming](graphics/B03968_05_05.jpg)
...
![Going under the hood of Spark Streaming](graphics/B03968_05_06.jpg)
...
![Setting up Kafka](graphics/B03968_05_07.jpg)
...
![Exploring flume](graphics/B03968_05_08.jpg)
...
![Developing data pipelines with Flume, Kafka, and Spark](graphics/B03968_05_09.jpg)

下图说明了流数据管道的概念及其关键组件：火花流、Kafka、Flume 和低延迟数据库。 在消费或控制应用程序中，我们实时监控我们的系统(由监视器描述)，或者在超过特定阈值的情况下发送实时警报(由红灯描述)。

![Developing data pipelines with Flume, Kafka, and Spark](graphics/B03968_05_10.jpg)
...
![Developing data pipelines with Flume, Kafka, and Spark](graphics/B03968_05_11.jpg)
...
![Understanding Lambda architecture](graphics/B03968_05_12.jpg)
...
![Understanding Kappa architecture](graphics/B03968_05_13.jpg)
