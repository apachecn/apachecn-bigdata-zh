...
下图描述了我们计划如何在中使用斯珀，并结合我们之前在[第 6 章](06.html#page "Chapter 6\. Adding NoSQL Persistence to Storm")、*中创建的拓扑之一，将 NoSQL 持久性添加到Storm*中。Storm 与斯珀的集成使开发人员能够在 Storm 正在处理的事件流之上执行类似 SQL 的查询。
