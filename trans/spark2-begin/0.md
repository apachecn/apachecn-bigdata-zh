...
[第 6 章](6.html "Chapter 6.  Spark Stream Processing")、*Spark流处理*讨论Spark流，这是最强大的Spark库之一，用于捕获和处理作为流摄入的数据。还讨论了作为分布式消息代理的卡夫卡和作为消费者的 Spark Streaming 应用程序。
...
[第 9 章](9.html "Chapter 9.  Designing Spark Applications")、*设计 Spark 应用程序*，讨论了 Spark 数据处理应用程序的设计和开发，涵盖了本书前几章中涉及到的 Spark 的各种特性。
