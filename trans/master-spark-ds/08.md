...
![Processing bytes](Images/image_08_001.jpg)
...
![Fast Fourier transform](Images/image_08_002.jpg)
...
![Fast Fourier transform](Images/image_08_003.jpg)
...
![Extracting audio signatures](Images/B05261_08_04.jpg)

图 3:频率注释参考表

*图 4* ，展示了我们的马里奥兄弟主题曲在较低频段的第一个样本。我们可以看到，43Hz 的最高幅度对应的是音符 **F** 的素八度:

![Extracting audio signatures](Images/image_08_005.jpg)
...
![Using the Play framework](Images/image_08_006.jpg)

图 5:声音分析器 UI

下面的*图 6* 显示了端到端的过程:

![Using the Play framework](Images/image_08_007.jpg)
...
![Building a playlist service](Images/B05261_08_08-2.jpg)
...
我们编译代码并将着色 jar 文件发布到作业服务器中，给它一个应用程序名，如下所示:
...
![Leveraging the Spark job server](Images/image_08_009.jpg)

图 8:播放列表推荐过程

个性化 PageRank 播放列表的流程如图 9 所示:

![Leveraging the Spark job server](Images/image_08_010.jpg)
...
![User interface](Images/B05261_08_11-1.jpg)
