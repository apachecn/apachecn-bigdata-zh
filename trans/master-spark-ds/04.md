...
下一章，也就是[第五章](05.html "Chapter 5. Spark for Geographic Analysis")、*地理分析 Spark*我们将探索几何；管理和探索本章中创建的 GeoGCAM 数据集的理想工具，以及 GeoServer 和 GeoTools 工具集，以进一步扩展我们的时空探索和可视化知识。