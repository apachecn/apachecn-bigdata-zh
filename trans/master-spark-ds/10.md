...
不用说，谷歌相当擅长索引网页。有超过一万亿个不同的网址，检测重复是索引网络内容的关键。毫无疑问，互联网巨头多年来一定开发出了解决这一规模问题的技术，因此限制了索引整个互联网所需的计算资源数量。这里描述的其中一种技术叫做 *Simhash* ，它是如此简单和整洁，尽管如此高效，以至于如果你真的想要*掌握数据科学的Spark*，那么它是值得了解的。
