...
[第 4 章](04.html#29DRA0-6149dd15e07b443593cc93f2eb31ee7b)，*Trident简介*，包括对Trident的介绍、对Trident数据模型的理解，以及如何编写Trident过滤器和函数。 本章还介绍了对Trident元组的重新分区和聚合操作。

[第 5 章](05.html#318PC0-6149dd15e07b443593cc93f2eb31ee7b)，*Trident拓扑和使用*，介绍了Trident元组分组、非事务性拓扑和一个Trident拓扑示例。 本章还介绍了Trident状态和分布式 RPC。
...
[第 7 章](07.html#3STPM0-6149dd15e07b443593cc93f2eb31ee7b)，*Storm集群的监控*，介绍了通过使用 Nimbus 发布的统计数据编写自定义监控 UI 来监控 Storm。 我们将使用 JMXTrans 解释 Ganglia 与 Storm 的集成。 本章还介绍了如何配置 Storm 以发布 JMX 指标。

[第 8 章](08.html#42KT20-6149dd15e07b443593cc93f2eb31ee7b)，*Storm与Kafka的集成*，展示了Storm与Kafka的集成。 本章从介绍 Kafka 开始，介绍 Storm 的安装，最后介绍 Storm 与 Kafka 的集成，以解决任何实际问题。
...
如果您是一名 Java 开发人员，并且热衷于使用 Apache Storm 进入实时流处理应用程序的世界，那么这本书是为您准备的。 由于本书从基础知识开始，因此不需要以前的Storm经验。 读完这本书后，您将能够开发不那么复杂的 Storm 应用程序。
