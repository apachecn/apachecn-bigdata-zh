...
Where ![](images/image_02_007.png) is the norm of ![](images/image_02_008.png). It is also called a unit vector.
...
![](images/image_02_013.png)

*   **标识函数**：对于任何域*D*，*IDD：D->D*将每个域元素*d*映射到其自身。

![](images/image_02_014.png)

*   **常量函数**：这是一个用水平线表示的特殊函数。

![](images/image_02_015.png)
...
![](images/image_02_024.png)

对*x*、*y*和λ进行微分，并设置为*0*，我们得到以下结果：

![](images/image_02_025.png)

![](images/image_02_026.png)

![](images/image_02_027.png)
...
![](images/image_02_029.png)

下图显示了包含 1000000 个元素的高斯分布：

![](images/image_02_030.png)
