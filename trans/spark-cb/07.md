...
![Introduction](graphics/3056_07_01.jpg)
...
![Getting ready](graphics/3056_07_04.jpg)
...
![Understanding cost function](graphics/3056_07_02.jpg)

此函数为，也称为**假设函数**，可写为：

![Understanding cost function](graphics/3056_07_03.jpg)

线性回归的目标是找到最适合的直线。 在这条线上，θ<sub>0</sub>表示*y*轴上的截距，而θ<sub>1</sub>表示该线的坡度，如以下公式所示：

![Understanding cost function](graphics/3056_07_05.jpg)

对于训练数据集，我们必须以*h(X)*最接近*y*的方式选择θ<sub>0</sub>和θ<sub>1</sub>。 因此，对于*i*<sup>第</sup>个数据点，直线与数据点之间距离的平方为：

![Understanding cost function](graphics/3056_07_06.jpg)

简而言之，这是预测房价与实际成交价之差的平方。 现在，让我们取训练数据集中此值的平均值：

![Understanding cost function](graphics/3056_07_07.jpg)

前面的方程式称为线性回归的成本函数*J*。 目标是最小化该成本函数。

![Understanding cost function](graphics/3056_07_08.jpg)
...
![Understanding cost function](graphics/3056_07_09.jpg)

假设θ<sub>1</sub>为 0，即平行于*x*轴的最佳拟合直线。 在第一种情况下，假设最佳拟合直线是*x*轴，即*y=0*。 下面是成本函数的值：

![Understanding cost function](graphics/3056_07_10.jpg)

现在，让将这条线稍微向上移动到*y=1*。 下面的将是成本函数的值：

![Understanding cost function](graphics/3056_07_11.jpg)

现在，让我们将这条线进一步向上移动到*y=2*。 然后，下面将是成本函数的值：

![Understanding cost function](graphics/3056_07_12.jpg)

现在，当我们将这条线进一步向上移动到*y=3*时，下面是成本函数的值：

![Understanding cost function](graphics/3056_07_13.jpg)

现在，让我们将这条线进一步向上移动到*y=4*。 下面的将是成本函数的值：

![Understanding cost function](graphics/3056_07_14.jpg)

因此，您可以看到成本函数值先是减少，然后又像这样增加：

![Understanding cost function](graphics/3056_07_15.jpg)

现在，让我们重复该练习，将θ<sub>0</sub>设为 0，并使用不同的θ<sub>1</sub>值。

在第一种情况下，假设最佳拟合直线是*x*轴，即*y=0*。 下面是成本函数的值：

![Understanding cost function](graphics/3056_07_16.jpg)

现在，让我们使用 0.5 的坡度。 下面是成本函数的值：

![Understanding cost function](graphics/3056_07_17.jpg)

现在，让我们使用斜率 1。下面的将是成本函数的值：

![Understanding cost function](graphics/3056_07_18.jpg)

现在，当我们使用斜率 1.5 时，下面是成本函数的值：

![Understanding cost function](graphics/3056_07_19.jpg)

现在，让我们使用 2.0 的坡度。 下面是成本函数的值：

![Understanding cost function](graphics/3056_07_20.jpg)

正如您在这两个图中所看到的，当曲线的斜率或坡度为 0 时，*J*的最小值。

![Understanding cost function](graphics/3056_07_21.jpg)
