...
![Introduction](graphics/3056_09_01.jpg)

正如您从上图中可以看到的，数据点正在形成两个群集，如下所示：

![Introduction](graphics/3056_09_02.jpg)
...
![Clustering using k-means](graphics/3056_09_01.jpg)

K-Means的第一步是随机选择两个称为**簇质心**的点：

![Clustering using k-means](graphics/3056_09_03.jpg)
...
![Clustering using k-means](graphics/3056_09_04.jpg)

现在，让我们将集群质心移动到集群中个数据点的平均值，如下所示：

![Clustering using k-means](graphics/3056_09_05.jpg)
...
![Getting ready](graphics/3056_09_06.jpg)

寻找多个星系团是一项棘手的任务。 在这里，我们有目视检查的优势，这对于超平面(三维以上)上的数据是不可用的。 让我们将数据大致划分为四个集群，如下所示：

![Getting ready](graphics/3056_09_07.jpg)
...
![Dimensionality reduction with principal component analysis](graphics/3056_09_08.jpg)

假设的目标是将这个二维数据分成一维。 做到这一点的方法是找到一条线，我们可以在其上投射这些数据。 让我们找一条适合将此数据投影到以下位置的行：

![Dimensionality reduction with principal component analysis](graphics/3056_09_09.jpg)

这是距数据点的投影距离最短的线。 让我们进一步解释一下，将每个数据点的最短行放到这条投影线上：

![Dimensionality reduction with principal component analysis](graphics/3056_09_10.jpg)
...
*   将要素值除以最大值会将每个要素置于![Getting ready](graphics/3056_09_22.jpg)范围内
*   将要素值除以范围，即最大值-最小值
...
![How to do it…](graphics/3056_09_11.jpg)

让我们在此数据中绘制一些模式，如下所示：

![How to do it…](graphics/3056_09_12.jpg)
...
![Dimensionality reduction with singular value decomposition](graphics/3056_09_10.jpg)

投影线显示一维的原始数据的最佳近似值。 如果我们取灰线与黑线相交的点并隔离黑线，我们将减少原始数据的表示，并保留尽可能多的变化，如下图所示：

![Dimensionality reduction with singular value decomposition](graphics/3056_09_13.jpg)

让我们画一条与第一条投影线垂直的线，如下图所示：

![Dimensionality reduction with singular value decomposition](graphics/3056_09_14.jpg)
...
![Dimensionality reduction with singular value decomposition](graphics/3056_09_15.jpg)

*U*和*V*是正交矩阵：

![Dimensionality reduction with singular value decomposition](graphics/3056_09_16.jpg)

![Dimensionality reduction with singular value decomposition](graphics/3056_09_17.jpg)

*U*的列是![Dimensionality reduction with singular value decomposition](graphics/3056_09_18.jpg)的正交特征向量，*V*的列是![Dimensionality reduction with singular value decomposition](graphics/3056_09_19.jpg)的正交特征向量。 *S*是包含从*U*或*V*的特征值的平方根按降序排列的对角矩阵。
...
![Getting ready](graphics/3056_09_20.jpg)

![Getting ready](graphics/3056_09_21.jpg)
