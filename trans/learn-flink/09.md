...
![Installing Google Cloud SDK](graphics/image_09_001.jpg)
...
![Launching a Flink cluster](graphics/image_09_002.jpg)
...
![Launching a Flink cluster](graphics/image_09_003.jpg)
...
![Launching a Flink cluster](graphics/image_09_004.jpg)
...
![Executing a sample job](graphics/image_09_005.jpg)

以下是执行所有任务的时间线的另一个截图:

![Executing a sample job](graphics/image_09_006.jpg)
...
![Shutting down the cluster](graphics/image_09_007.jpg)
...
![Launching an EMR cluster](graphics/image_09_008.jpg)

接下来，我们转到 EMR 控制台，启动一个包含一个主节点和两个从节点的三节点集群。在这里，我们选择最小集群大小，以避免意外计费。以下屏幕截图显示了 EMR 集群创建屏幕:

![Launching an EMR cluster](graphics/image_09_009.jpg)
...
![Launching an EMR cluster](graphics/image_09_010.jpg)

现在，我们都设置为使用带有私钥的 SSH 登录到主节点。使用 Hadoop 用户名登录后，您将看到以下屏幕:

![Launching an EMR cluster](graphics/image_09_011.jpg)
...
![Executing Flink on EMR-YARN](graphics/image_09_012.jpg)
...
![Starting a Flink YARN session](graphics/image_09_013.jpg)
...
![Executing Flink job on YARN session](graphics/image_09_014.jpg)

我们还可以看到所有任务并行执行和顺序执行的时间线细节。下面是同样的截图:

![Executing Flink job on YARN session](graphics/image_09_015.jpg)
...
![Flink on EMR 5.3+](graphics/image_09_016.jpg)

接下来，您将看到一个屏幕，让您选择想要的附加服务。您需要检查 Flink 1.1.4:

![Flink on EMR 5.3+](graphics/image_09_017.jpg)
