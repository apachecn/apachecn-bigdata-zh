...
![Technical overview](../images/00017.jpeg)
...
然而，限制在于，在基于火花的 GLM 算法的当前实现中，仅支持指数族分布的子集。此外，还有另一个可扩展性问题，即通过其`GeneralizedLinearRegression` API 仅支持 4096 个特性。因此，如果特征数超过 4096，算法将抛出异常。
...
![Generalized linear regression with Spark](../images/00153.jpeg)
...
![Generalized linear regression with Spark](../images/00002.jpeg)
...
![Adapting SVMs for new data with Spark](../images/00096.jpeg)
...
![Adapting SVMs for new data with Spark](../images/00051.jpeg)
...
![Multilayer perceptron classification with Spark](../images/00044.jpeg)
...
注意，创建并返回火花会话对象的`mySession()`方法如下:
...
![Classification using Naive Bayes with Spark](../images/00035.jpeg)
...
![Data exploration](../images/00091.jpeg)
...
以下是创建并返回活动火花会话的`UtilityForSparkSession`类:
...
![Developing a heart diseases predictive model](../images/00047.jpeg)
...
![Machine learning in dynamic environments](../images/00021.jpeg)
...
![Online learning](../images/00016.jpeg)
