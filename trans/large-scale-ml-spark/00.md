...
[第 5 章](05.html#190862-0b803698e2de424b8aa3c56ad52b005d "Chapter 5.  Supervised and Unsupervised Learning by Examples")、*通过示例进行监督和无监督学习*，将在前面章节的基础上，通过一些广泛使用的示例，提供围绕如何将可用数据上的监督和无监督技术快速有力地应用于新问题的实用知识。这些例子将从Spark的角度进行演示。
...
在 Windows 环境中创建Spark会话的代码块设置如下:
