...
![Data visualization](graphics/B01989_09_04.jpg)
...
![Data visualization](graphics/B01989_09_05.jpg)

显然，**管理**分组大约为**1400 万**。 将显示选项更改为**Pie**将数据表示为饼图，具有清晰大小的线段和颜色，直观而清晰地呈现数据和最重要的项目。

![Data visualization](graphics/B01989_09_06.jpg)
...
![Dashboards](graphics/B01989_09_11.jpg)
...
![An RDD-based report](graphics/B01989_09_12.jpg)

下面的屏幕截图显示了这个Scala 示例允许创建的条形图。 前面的 Scala 代码和下面的屏幕截图不如使用数据框以编程方式创建此图这一事实重要：

![An RDD-based report](graphics/B01989_09_13.jpg)
...
![A stream-based report](graphics/B01989_09_14.jpg)
...
![A stream-based report](graphics/B01989_09_15.jpg)
...
![A stream-based report](graphics/B01989_09_16.jpg)

在前面的屏幕截图中还有选项用于重新生成密钥和设置权限。 下一个屏幕截图显示了应用程序访问令牌的详细信息。 有一个访问令牌和一个访问令牌密码。 它还具有重新生成值和撤销访问权限的选项：

![A stream-based report](graphics/B01989_09_17.jpg)
...
然后，我通过 Spark stream 上下文`ssc`使用`start`和`awaitTermination`来启动应用程序，并保持其运行直到停止：
...
![A stream-based report](graphics/B01989_09_20.jpg)
...
![Library import](graphics/B01989_09_28.jpg)
