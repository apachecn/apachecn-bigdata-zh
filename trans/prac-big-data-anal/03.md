...
![](assets/5f4e6fd5-7222-44df-8dde-285179777cfe.png)
...
![](assets/07af8be9-d8b5-4dd4-aa40-939c32fa1017.png)

Selecting Virtualbox on the Cloudera Quickstart download options

我们会看到以下登录屏幕：

![](assets/bde98a13-9d07-4e2d-89b2-02fd8ab0640a.png)

CDH Sign-up Screen

条款和条件首先列明：

![](assets/be724313-71a0-43f5-8564-ee32d9143ffe.png)

CDH License Terms Acceptance

CDH 的虚拟机下载启动：

![](assets/5be34160-d3a4-4bbf-b3a2-2489b9ddb1bd.png)

The CDH VM is more than 5 GB and can take a while to download

解压缩该文件。 该文件夹将包含如下图所示的文件：

![](assets/0a72690d-4d51-4c7b-9e28-7f2ed7cd85ad.png)
...
![](assets/f51efb5f-7a67-4e04-b925-bc9df112a039.png)
...
![](assets/f44ed70d-e9bf-47f8-911e-01296b0204e5.png)

Oracle Virtualbox with CDH VM loaded

8.  操作系统初始化时保留默认设置：

![](assets/d69bb7dd-825d-417c-997a-b0cbd773f49a.png)

CDH Main OS page

作为安装的最后一步，我们会看到以下屏幕：

![](assets/ab31e475-2915-4487-bdf2-246076004f4b.png)
...
![](assets/238da29e-0b38-4c63-8066-2b0883fcda1d.png)

Download page for Vagrant

下载完成后，通过运行下载的 Vagant 安装文件安装**Vagrant**。 安装完成后，您将得到重新启动计算机的提示。 重新启动系统，然后继续下一步加载流浪文件：

![](assets/d16afa7f-3966-4b3a-a56c-69ae455e53bb.png)

Completing the Vagrant Installation

单击最后一步中的确认以重新启动：

![](assets/cbb66e09-5d38-4432-b13f-d4122a477b0c.png)
...
![](assets/f6163874-61fe-48a6-a483-adb895b54e8d.png)

Oracle Virtualbox with Packt Data Science VM

双击该框的名称以启动(并测试)它。 以`packt/packt`身份使用 ID/密码登录：

![](assets/3afcc04e-8dc4-4aa3-b597-2a79f2a8c93f.png)
...
![](assets/2d9fb072-c8a3-4cb6-8629-c192eef6dece.png)

Microsoft Open R Homepage

2.  选择适合您的系统(Windows、MacOS 或 Linux)的发行版：

![](assets/b54a3b99-6bf9-48c2-ab31-0682ea7254d3.png)
...
![](assets/02cad43d-195b-4cba-9f26-d968c9ce7942.png)

R Studio Versions

2.  单击与您的操作系统相关的链接，下载并安装相应的文件：

![](assets/197b4d13-8d07-4a92-b627-089b2ab311fb.png)

Downloading RStudio

3.  请注意，在 MacOS 上，您只需将下载的文件移动到 Applications 文件夹即可。 在 Windows 和 Linux 操作系统上，双击下载的文件，完成文件安装步骤：

![](assets/e1b61465-92ef-4416-b3b0-c9fa07fd8bca.png)
